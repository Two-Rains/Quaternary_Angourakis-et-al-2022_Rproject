...
#' @param windSpeed : mean daily wind speed at 2m (m s-1). Default is 2m/s as recommended by http://www.fao.org/3/X0490E/x0490e07.htm#estimating%20missing%20climatic%20data
...
#' @param albedo : canopy reflection or albedo of the surface cover. Default is 0.23 assuming hypothetical grass reference crop.
#' @return vector with daily ETr (mm day-1)
#' @export
estimateETr <- function(R_s, Temp,  maxTemp, minTemp, dewTemp = NULL, windSpeed = 2, method = "PM", elevation = 200, albedo = 0.23)
{
  ETr <- NULL
